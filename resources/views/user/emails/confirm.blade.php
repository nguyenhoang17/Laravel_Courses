                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Xin chào</h1>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Chúng tôi đã nhận được yêu cầu thay đổi mật khẩu của bạn, vui lòng bấm xác nhận đổi mật khẩu để chuyển đến trang thay đổi mật khẩu
                                        </p>
                                        <p>Cảm ơn bạn đã sử dụng dịch vụ của chúng tôi!</p>
                                        <a 
                                            href="{{ route('user.reset-password',$token) }}"
