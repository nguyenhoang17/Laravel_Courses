@section('css')
    <link href="/admin/dist/assets/css/runcourse/list.css" rel="stylesheet"/>
            ...
            <div class="card-body py-4">
                ...
                <table id="courses" class="">
                    ...
                    <tr class="text-start text-muted fw-bolder fs-7 gs-0">
                        ...
                        <th class="min-w-125px text-center">Start_live</th>
                    </tr>
                    <!--end::Table row-->
                    </thead>
                </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="width: 700px;">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-muted">Key: <span id="key" class="fw-bolder fs-6 text-dark"></span></p>
...
@section('js')
    <script src="/admin/dist/assets/js/runcourse/list.js"></script>
